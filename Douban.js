{
	...
	"target": "^https?://(www|book)\\.douban\\.com/(subject|doulist|people|url/[a-zA-Z._]*/(do|wish|collect)|.*?status=(do|wish|collect)|group/[0-9]*?/collection|tag)",
	"minVersion": "2.0rc1",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	...
	"lastUpdated": "2019-10-22 10:09:34"
}
...
/**
 * It's strange that Safari can't open following url
 *    https://www.douban.com/url/9552666/
 * while chrome can.
 */
function saveWeb (url, title) {
